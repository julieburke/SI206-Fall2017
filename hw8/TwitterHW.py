...
##YOUR CODE HERE
    ...
    if "umsi" in CACHE_DICTION:
        ...
        return CACHE_DICTION["umsi"] #return the results from cache 
    else:
        print("fetching") #let user know what is happening
        #results = api.search("umsi") #make request to twitter 
...
print ("more more_than_2_rts - %s " % set(more_than_2_rts))
